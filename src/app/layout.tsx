...
import GeometricBackground from '@/components/layouts/GeometricBackground';
      ...
      <body className="scroll-smooth h-full w-full bg-background text-foreground overflow-x-hidden">
        <I18nProvider>
          ...
          <div className="flex flex-col min-h-screen w-full" style={{ position: 'relative', zIndex: 1 }}>
            <Navbar />
            <main className="flex-grow w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">{children}</main>
            <Footer />
          </div>
        </I18nProvider>
      </body>
