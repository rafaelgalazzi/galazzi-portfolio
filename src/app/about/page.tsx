...
export default function About() {
  ...
  const slides = [
    ...
    <>
        ...
        <BaseText className="mt-10" fontSize="xxxl" justify="center" color="text-white">{t("about.certifications.title")}</BaseText>
        ...
        <BaseText className="mt-10" fontSize="xxxl" justify="center" color="text-white">{t("about.additionalCourses.title")}</BaseText>
